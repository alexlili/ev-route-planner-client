...
import { createFavouriteChargerList } from "../graphql/mutations";
const client = generateClient();
export default function FavouriteChargerListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setAddressInfo(initialValues.addressInfo);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFavouriteChargerList.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FavouriteChargerListCreateForm")}
      {...rest}
    >
      <TextAreaField
        label="Address info"
