...
import { createSearchLoactionList } from "../graphql/mutations";
const client = generateClient();
export default function SearchLoactionListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSearchLoactionList.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SearchLoactionListCreateForm")}
      {...rest}
    >
      <TextAreaField
        label="Address info"
